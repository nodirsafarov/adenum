...
from adenum_lib import reporters, ui  # noqa: E402
from adenum_lib.runner import detect_tools, set_opsec  # noqa: E402
from adenum_lib.stages import (  # noqa: E402
    stage0, stage1, stage2, stage3, stage_aggressive, stage_passive,
)
from adenum_lib.state import (  # noqa: E402
...
========
  ...
  ./adenum.py 10.10.10.5 -d htb.local --users users.txt -v
  ./adenum.py 10.10.10.5 -d htb.local -u admin -p Pass123 -v
  ./adenum.py 10.10.10.5 -d htb.local --aggressive --html report.html
  ./adenum.py 10.10.10.5 -d htb.local --passive
  ./adenum.py 10.10.10.5 -d htb.local --spray-pass Summer2024! --users users.txt
  ./adenum.py 10.0.0.0/24                 # CIDR sweep (each IP -> separate loot/)
  ./adenum.py -T targets.txt              # one IP per line
"""
